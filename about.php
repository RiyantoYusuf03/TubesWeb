...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="hero-2" style="background-image: url('images/cantik.png');">
     <div class="container">
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5">
            ...
            <p>Onderdil atau suku cadang adalah komponen dari mesin yang dicadangkan untuk perbaikan atau penggantian bagian kendaraan yang mengalami kerusakan. Suku cadang merupakan bagian penting dalam manajemen logistik dan manajemen rantai suplai.</p>
            <p></p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 mr-auto">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black font-heading-serif">Sparepart For You All</h2>
            </div>
            <p> Spare Part adalah suatu barang yang terdiri dari beberapa komponen yang membentuk satu kesatuan dan mempunyai fungsi tertentu. Setiap alat berat terdiri dari banyak komponen, namun yang akan dibahas komponen yang sering mengalami kerusakan dan penggantian.</p>
            <p></p>
